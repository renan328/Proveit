...
export default function ReceitaSingle({ navigation }) {
    ...
    async function addSave() {
        ...
        if (!saved) {
            ...
            fetch("https://proveitserverapi.azurewebsites.net/api/ReceitaFavorita", {
                method: "POST",
                headers,
            ...
            fetch("https://proveitserverapi.azurewebsites.net/api/ReceitaFavorita/" + receita_id + "/" + usuario_id, {
                method: "DELETE",
                headers,
            })
                .then((response) => {
    ...
    function handleAssessment() {
        ...
        fetch("https://proveitserverapi.azurewebsites.net/api/avaliacao", {
            method: "POST",
    ...
    async function BuscarReceita() {
        ...
        fetch("https://proveitserverapi.azurewebsites.net/api/receita/" + id, {
            method: "GET",
            headers
        })
    ...
    async function VerificarFavorito() {
        ...
        fetch("https://proveitserverapi.azurewebsites.net/api/ReceitaFavorita/verificar/" + id + "/" + userDataJWT.ID, {
            method: "GET",
            headers
        })
                ...
                <View style={styles.comments}>
                    <View style={styles.commentsHeader}>
                        <LottieView
                            ...
                            autoPlay
                            loop
                            style={{ height: 50, width: 100, alignSelf: 'center', marginBottom: 10 }}
                        />
