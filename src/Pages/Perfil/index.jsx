...
export default function Perfil({ navigation }) {
    ...
    async function Adicionados() {
        ...
        fetch("https://proveitserverapi.azurewebsites.net/api/receita/usuario/" + userDataJWT.ID, {
            method: "GET",
            headers
        })
    ...
    async function BuscarUsuario() {
        ...
        fetch("https://proveitserverapi.azurewebsites.net/api/usuario/" + userDataJWT.ID, {
            method: "GET",
            headers
        })
            .then((response) => response.json())
