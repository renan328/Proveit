...
export default function ReceitaSingle({ navigation }) {
    ...
    async function VerificarFavorito() {
        ...
        fetch("https://proveittestes.azurewebsites.net/api/ReceitaFavorita/verificar/" + id + "/" + userDataJWT.ID, {
            method: "GET",
            headers
        })
    ...
    async function addSave() {
        ...
        if (!saved) {
            ...
            fetch("https://proveittestes.azurewebsites.net/api/ReceitaFavorita", {
                method: "POST",
                headers,
            ...
            fetch("https://proveittestes.azurewebsites.net/api/ReceitaFavorita/" + receita_id + "/" + usuario_id, {
                method: "DELETE",
                headers,
            })
                .then((response) => {
