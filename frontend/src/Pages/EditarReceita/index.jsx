...
export default function EdicaoDeReceita({ navigation, props }) {
    ...
    async function EditarReceita() {
        ...
        fetch("https://proveitserverapi.azurewebsites.net/api/receita", {
            method: "PUT",
            headers,
                            ...
                            <View key={index} style={styles.addableComponent}>
                                ...
                                <View style={{ flexDirection: 'row', display: 'flex', width: '80%', justifyContent: 'flex-start' }}>
                                    ...
                                    <View style={[styles.ListaInput, errors.ingredientes && errors.ingredientes[index] && styles.inputError]}>
                                        ...
                                        >
                                            <Picker.Item style={{ color: scheme === 'dark' ? '#DDD' : '#505050', fontFamily: 'Raleway_500Medium', }} label="Medidas:" value="" enabled={false} />
