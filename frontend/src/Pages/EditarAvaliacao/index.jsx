...
export default function EdicaoDeAvaliacao({ navigation, props }) {
    ...
    async function BuscarAvaliacao() {
        ...
        fetch("https://cloudproveit.azurewebsites.netzurewebsites.net/api/avaliacao/unica/" + id, {
            method: "GET",
            headers
        })
    ...
    async function EditarAvaliacao() {
        ...
        fetch("https://cloudproveit.azurewebsites.netzurewebsites.net/api/avaliacao", {
            method: "PUT",
            headers,
